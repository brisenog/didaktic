...
/**
 * Strings for component 'oublog', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   oublog
...
$string['import'] = 'Importar publicaciones';
$string['import_notallowed'] = 'La importación de publicaciones está deshabilitada para este  {$a}.';
$string['import_step0_inst'] = 'Seleccionar una actividad de la cual importar publicaciones:';
...
$string['import_step1_submit'] = 'Importar publicaciones';
...
$string['import_step2_conflicts'] = '{$a} publicaciones a importar fueron identificadas como conflictivas con publicaciones existentes.';
$string['import_step2_conflicts_submit'] = 'Importar publicaciones conflictivas';
...
$string['import_step2_total'] = 'Importadas {$a} publicaciones.';
