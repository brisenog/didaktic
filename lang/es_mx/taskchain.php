...
$string['completedalltasks_close'] = 'Si Usted quiere terminar y cerrar este intento, haga click en el botón inferior.<br />Tenga en cuenta que Usted no podrá re-hacer tareas en este intento después de que haya sido cerrado.';
$string['completedalltasks_redo'] = 'Si Usted quiere re-hacer una de las tareas en esta actividad, haga click en el nombre de la tarea en la lista inferior.';
...
**Usar configuracionees en archivo fuente/plantilla**
...
**Esperar hasta que el estudiante haga click en OK**
: el control será regresado a Moodle después de que el estudiante haga click el botón OK en el mensaje de finalización en la tarea.
...
**Si**
: Después de completar todas las tareas, los estudiantes podrán re_hacer tareas y deben de hacer click manualment en un botón para terminar un intento de tarea.';
...
$string['modulename_help'] = 'El módulo TaskChain (CadenadeTarea) le permite a los maestros distribuir materiales interactivos de aprendizaje a sus alumnos mediante Moodle y ver reportes acerca de las respuestas de los alumnos y resultados.
...
* Para inforación acerca de subir módulos Qedoc vea: [Qedoc documentation: Uploading_modules](http://www.qedoc.org/en/index.php?title=Uploading_modules)';
...
$string['task'] = 'Tarea';
$string['taskaction_help'] = 'Estas opciones especifican cual acción se tomará cuando se haga click en el botón para "Ir"..

**Reordenar tareas**
: Las tareas serán reordenadas de acuerdo a los nuevos números de ordenamiento.
...
: Los valores por defecto seleccionados serán aplicados a las tareas selecconadas.
