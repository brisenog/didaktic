...
/**
 * Strings for component 'pcast', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   pcast
...
Los episodios pueden verse alfabéticamente o por categoría, fecha o autor. Los episodios pueden ser aprobados por defecto o requerir aprobación por un maestro antes de que puedan ser vistos por todos.

Un maestro puede permitir comentarios a los episodios. Los episodios también pueden ser valorados por maestros o estudiantes (valuación por pares). Las valoraciones son agregadas para formar una calificación final que se guarda en el libro de calificaciones.
