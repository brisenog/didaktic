...
$string['accessnoticesheader'] = 'Puede previsualizar este examen, pero si éste fuera un intento real, Usted estaría bloqueado debido a que :';
...
$string['graceperiod_desc'] = 'Si se configura que cuando se agote el tiempo a "hay un período de gracia para enviar el intento, pero no pueden contestarse más preguntas", la cantidad por defecto de tiempo extra que se permite, en segundos. 300 = 5 minutos; 86400 = 24 horas.';
$string['graceperiod_help'] = 'Si se configura que cuando se agote el tiempo a "hay un período de gracia para enviar el intento, pero no pueden contestarse más preguntas", la cantidad por defecto de tiempo extra que se permite.';
...
$string['quiz:emailwarnoverdue'] = 'Recibir un mensaje de notificación cuando un intento está retrasado y necesita ser enviado.';
...
$string['reviewoptionsheading_help'] = 'Estas opciones controlan qué información pueden ver los alumnos cuando revisan un intento de resolver el examen o cuando consultan los reportes correspondientes.
