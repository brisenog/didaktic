...
$string['modulename_help'] = 'El módulo de Lista de Cotejo (checklist) le permite al maestro crear una lista de cotejo / lista de trabajos/ lista de pendientes, para que sus estudiantes trabajen al respecto.';
