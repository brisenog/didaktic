...
/**
 * Strings for component 'block_spam_deletion', language 'es_mx', branch 'MOODLE_24_STABLE'
 *
...
$string['cannotdelete'] = 'No se puede eliminar el contenido de esta cuenta';
...
$string['notrecentlyaccessed'] = 'La fecha del primer acceso de esta cuenta es de hace más de 1 mes, por lo el contenido de este usuario no puede ser eliminado.';
