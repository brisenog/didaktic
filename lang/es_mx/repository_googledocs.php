...
$string['oauth2upgrade_message_content'] = 'Como parte de la actualización a Moodle 2.3, el plugin del repositorio de Google Drive ha sido deshabilitado  Para re-habilitar su plugin, su sitio Moodle debe ser registrado con Google, tal como se describe en la documentación {$a->docsurl}, para poder obtener una ID y un secreto de cliente. La ID del cliente y el secreto podrán entonces emplearse para configurar todos los plugins de Google Drive y Picasa.';
...
$string['oauth2upgrade_message_subject'] = 'Información importante acerca del plugin del repositorio Google Drive';
