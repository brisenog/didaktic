...
$string['auth_shib_contact_administrator'] = 'En el caso de que Usted no esté asociado con las organizaciones dadas y que requiera accesar un curso en este servidor, por favor contacte con el (Administrador de este Moodle)  <a href="mailto:{$a}">Moodle Administrator</a>.';
