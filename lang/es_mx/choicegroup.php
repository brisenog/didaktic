...
/**
 * Strings for component 'choicegroup', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   choicegroup
...
$string['groupdoesntexist'] = 'Algunos de los grupos especificados no existen dentro del curso. El maestro debería crear los grupos necesarios y/o modificar esta actividad.';
...
$string['numberofuser'] = 'El número de usuario';
$string['option'] = 'Grupo';
$string['page-mod-choice-x'] = 'Cualquier página de módulo de selección de grupo';
$string['pleasesetgroups'] = 'Por favor, cree al menos dos grupos dentro de este curso.';
