...
/**
 * Strings for component 'block_tags', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   block_tags
...
$string['defaultdisplay'] = 'Tipo de marca a mostrar';
$string['disabledtags'] = 'Las marcas están desactivadas';
$string['edit'] = 'edición...';
$string['editdeletemytag'] = 'Eliminar marca de este curso';
$string['editmytags'] = 'Mis marcas - atajos a todos los cursos marcados.';
...
$string['edittagthisunit'] = 'Agregar marca a este curso:';
...
$string['jserror2'] = 'Las marcas no pueden tener caracteres especiales (, <, >). Por favor, corríjalas.';
$string['login'] = 'entrar';
$string['more'] = 'más...';
...
$string['showcoursetagsdef'] = 'Mostrar la capacidad de marcado de curso en el bloque de marcas, permitiendo a los estudiantes marcar cursos.';
$string['suggestedtagthisunit'] = 'Marca sugerida para este curso:';
$string['tags'] = 'marcas';
$string['tags:addinstance'] = 'Añadir un nuevo bloque de marcas';
$string['tags:myaddinstance'] = 'Añadir un nuevo bloque de marcas a Mi Hogar';
