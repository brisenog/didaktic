...
/**
 * Strings for component 'facetoface', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   facetoface
...
$string['cancellationstablesummary'] = 'Lista de personas que han cancelado sus registros a la sesión';
...
Si hay texto en el campo de detalles, el texto de detalles se mostrará en la página de registro del usuario.
...
$string['error:cannotsendrequestmanager'] = 'Hubo un problema al enviar el mensaje de solicitud de registro a la cuenta de Email de su mánager.';
$string['error:cannotsendrequestuser'] = 'Hubo un problema al enviar el mensaje de solicitud de registro a su cuenta de Email.';
...
$string['error:manageremailaddressmissing'] = 'Usted actualmente no está asignado a un mánager en el sistema. Por favor contacte con eal administrador del sitio.';
