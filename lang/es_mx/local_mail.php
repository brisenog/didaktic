...
/**
 * Strings for component 'local_mail', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   local_mail
...
$string['markasstarred'] = 'Marcar con estrella';
$string['markasunread'] = 'Marcar como no-leído';
$string['markasunstarred'] = 'Marcar sin estrella';
...
$string['starred'] = 'Con estrella';
$string['starredmail'] = 'Con estrella';
