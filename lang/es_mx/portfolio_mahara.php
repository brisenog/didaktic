...
$string['mnet_noid'] = 'No pudo encontrar el registro concordante con la transferencia para este token';
$string['mnet_notoken'] = 'No pudo encontrarse el token que concuerde con esta transferencia';
$string['mnet_wronghost'] = 'El host remoto no concordó el registro de transferencia para este token';
