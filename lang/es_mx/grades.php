...
$string['enableoutcomes_help'] = 'Apoyo para los Resultados (también conocidos como \'Competencias\', \'Objetivos\',  \'Metas\', \'Estándares\' o \'Criterios\'). Significa que calificamos usando una o más escalas que están conectadas a las declaraciones de resultados. La activación de los resultados posibilita esta forma especial de calificación en todo el sitio.';
