...
/**
 * Strings for component 'block_badgeawarder', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['badgeawarder:addinstance'] = 'Añadir un bloque de Otorgador de Insignias';
...
$string['cityrequired'] = 'Ciudad requerida para nuevos usuarios';
$string['completion'] = 'Finalización';
$string['countryrequired'] = 'Selección de país requerida para usuarios nuevos';
...
nombre_de_usuarioi {$a->username}<br>
contraseña: {$a->newpassword}<br>
<br>
Usted necesitará cambiar su contraseña cuando ingrese por primera vez.<br>';
...
$string['pluginname'] = 'Otorgante de insignias';
