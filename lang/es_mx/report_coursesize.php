...
/**
 * Strings for component 'report_coursesize', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['coursesize_desc'] = 'Este reporte proporciona valores aproximados, pero si un archivo es usado varias veces dentro de un curso, o en varios cursos, el reporte cuanta cada instancia, aunque Moodle solamente almacena una versión física en el disco.';
