...
/**
 * Strings for component 'bigbluebuttonbn', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['bbbfinished'] = 'Esta actividad ha terminado.';
$string['bbbinprocess'] = 'Esta actividad está en proceso.';
$string['bbbnorecordings'] = 'Todavía no hay grabación, por favor regrese más tarde.';
...
$string['bbburl'] = 'La URL de su servidor BigBlueButton debe terminar con  /bigbluebutton/. (Esta URL por defecto es para un servidor BigBlueButton proporcionado por Blindside Networks que Usted puede usar para prueba.)';
...
$string['bigbluebuttonbnSalt'] = 'Clave secreta de BigBlueButton';
$string['bigbluebuttonbnUrl'] = 'URL del Servidor BigBlueButton';
$string['bigbluebuttonbnWait'] = 'El usuario tiene que esperar';
$string['configsecuritysalt'] = 'La sal de seguridad de su servidor BigBlueButton. (Esta sal por defecto es para un servidor de BigBlueButton proporcionado por  Blindside Networks para fines de prueba),';
...
$string['index_warning_adding_meeting'] = 'No se pudo asignar un nuevo ID a la sesión.';
...
$string['mod_form_block_schedule'] = 'Agenda para sesiones';
$string['mod_form_field_allmoderators'] = 'Permitir a todos los participantes ser moderadores';
$string['mod_form_field_availabledate'] = 'Acceso abierto';
$string['mod_form_field_description'] = 'Descripción de sesiones grabadas';
...
$string['mod_form_field_duedate'] = 'Acceso cerrado';
...
$string['mod_form_field_userlimit_help'] = 'Número máximo de usuarios permitidos en una reunión';
$string['mod_form_field_voicebridge'] = 'Puente de voz';
$string['mod_form_field_voicebridge_help'] = 'Número de la conferencia de voz que los participantes pueden teclear para unirse a la conferencia de voz.';
$string['mod_form_field_wait'] = 'Los observadores deben esperar hasta que ingrese un moderaror';
...
$string['view_error_no_group_teacher'] = 'Todavía no se han configurado grupos. Por favor haga los grupos o contacte con el Administrador.';
...
$string['view_error_unable_join_student'] = 'No se pudo conectar al servidor BigBlueButton. Por favor contacte con su Maestro o Administrador.';
$string['view_error_unable_join_teacher'] = 'No se pudo conectar al servidor BigBlueButton. Por favor contacte con el Administrador.';
...
$string['view_wait'] = 'La clase virtual todavía no ha comenzado. Esperando a que ingrese un moderador ...';
