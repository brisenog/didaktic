...
$string['apiv1migration_message_content'] = 'Como parte de la reciente actualización a Moodle 2.5.3, el plugin del portafolio Box ha sido deshabilitado. Para re-habilitarlo, Usted necesita re-configurarlo como se describe en la documentación {$a->docsurl}.';
$string['apiv1migration_message_small'] = 'Este plugin ha sido deshabilitado, porque requiere configuración como se describe en el documento acerca de migración de Box APIv1.';
$string['apiv1migration_message_subject'] = 'Información importante acerca del plugin del portafolio Box';
...
$string['noauthtoken'] = 'No pudo recuperar un token de autenticación para emplear en esta sesión';
