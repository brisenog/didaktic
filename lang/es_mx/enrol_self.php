...
$string['expiredaction_help'] = 'Elegir la acción a tomar cuando caduque la inscripción del usuario. Por favor tenga en cuenta que algunos datos y configuraciones del usuario son purgados del curso al des-inscribirse del curso.';
...
Si requiere ayuda, por favor contacte con  {$a->enroller}.';
