...
$string['assignmentmailhtml'] = '<p>{$a->teacher} ha publicado retroalimentación para su envío de tarea \'\'<i>{$a->assignment}</i>\'.</p>
<p>Puede verlo añadido en su <a href="{$a->url}">envío de tarea</a>.</p>';
...
{$a->url}';
$string['emailteachermailhtml'] = '<p>{$a->username} ha actualizado la entrega de su tarea
para <i>\'{$a->assignment}\' en {$a->timeupdated}</i>.</p>
<p>Está <a href="{$a->url}">disponible en el sitio web</a>..</p>';
