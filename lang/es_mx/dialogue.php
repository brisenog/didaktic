...
/**
 * Strings for component 'dialogue', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   dialogue
...
$string['dialogueupgradehelper'] = 'Ayudante de actualización de diálogo';
...
$string['upgradedcount'] = 'Diálogos {$a} actualizados';
$string['upgradeiscompleted'] = 'Actualización completada';
$string['upgradenodialoguesselected'] = 'Sin diálogos seleccionados';
$string['upgradenoneedupgrade'] = '{$a} diálogos necesitan actualizarse';
$string['upgradereport'] = 'Enlistar diálogos para actualizarse';
$string['upgradeselected'] = 'Actualizar diálogos seleccionados';
$string['upgradingresultfailed'] = 'Resultado: Falló la actualización';
