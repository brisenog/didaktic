...
/**
 * Strings for component 'theme_aigne', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   theme_aigne
...
$string['usermenu'] = 'En el Encabezado, en el nuevo estilo de menú de usuario (ingreso + menú desplegable)';
