...
$string['explainexport'] = 'Haga click en el botón inferior para exportar entradas del Glosario.<br />Usted puede importarlas en ciualquier momento que así lo desee en éste o en otros cursos.<p>Por favor tenga en cuenta que los anexos (como por ejemplo, las imágenes) y los autores no son exportados.</p>';
