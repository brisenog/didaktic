...
$string['cannotcreatetoken'] = 'No hay permiso para crear el token de servicio web para el servicio {$a}.';
...
$string['createtokenforuser'] = 'Crear token para un usuario';
$string['createtokenforuserdescription'] = 'Crear token para usuario de servicios web.';
...
$string['deletetokenconfirm'] = '¿Realmente desea eliminar este token para servicio web para <strong>{$a->user}</strong> en el servicio <strong>{$a->service}</strong>?';
...
$string['forbiddenwsuser'] = 'No puede crearse el token para un usuario sin-confirmar, borrado, suspendido o invitado.';
...
$string['invalidiptoken'] = 'Token no válido - su IP no es admitida';
$string['invalidtimedtoken'] = 'Token no válido - token caduco';
$string['invalidtoken'] = 'Tokenno válido - token no encontrado';
...
$string['onesystemcontrolling'] = 'Permitirle a un sistema externo controlar a Moodle con un token';
$string['onesystemcontrollingdescription'] = 'Los pasos siguientes le ayudarán a configurar un servicio web para permitir que un sistema externo interactúe con Moodle. Esto incluye configurar un token (clave de seguridad) como método de autenticación.';
...
$string['restoredaccountresetpassword'] = 'La cuenta restaurada necesita resetear la contraseña antes de obtener un token.';
$string['restparam'] = 'REST (parámetros POST)';
$string['restrictedusers'] = 'Únicamente usuarios autorizados';
$string['restrictedusers_help'] = 'Esta configuración determina si todos los usuarios con permiso para crear un token de servicios web pueden generar ese token mediante sus páginas de claves de seguridad o solamente los usuarios autorizados podrán hacerlo.';
...
$string['testwithtestclientdescription'] = 'Simula el acceso externo al servicio usando el cliente de prueba de servicio web. Use un protocolo permitido con autenticación por token. <strong>ADVERTENCIA: ¡Las funciones que Usted pruebe SERÄN EJECUTADAS para este usuario, por lo que debe ser cauteloso con lo que decida probar!</strong>';
$string['token'] = 'Ficha';
$string['tokenauthlog'] = 'Autenticación mediante token';
