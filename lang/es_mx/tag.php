...
/**
 * Strings for component 'tag', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   tag
...
$string['addedotag'] = '"{$a}" se añadió como marca oficial.';
...
$string['id'] = 'id';
$string['manageofficialtags'] = 'Administrar marcas oficiales';
...
$string['newname'] = 'Nuevo nombre de marca';
...
$string['thistaghasnodesc'] = 'Esta marca no tiene descripción actualmente';
...
$string['withselectedtags'] = 'Con marcas seleccionadas...';
