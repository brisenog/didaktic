...
/**
 * Strings for component 'revealjs', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   revealjs
...
$string['autoslide_help'] = 'Automáticamente mover a la siguiente imagen con reloj. Solamente puede configurarse un reloj para todas las imágenes.';
$string['backgroundtransition'] = 'Transición de Fondo';
...
$string['data_dir_error'] = 'Por favor revise: Ocurrió un error al intentar mover el directorio  /moodle/mod/swf/swf/  y todos sus contenidos a :';
...
$string['margin_help'] = 'Factor del tamaño de la imagen que debería de permanecer vacía alrededor del contenido:0.1 = 10%';
$string['maxscale'] = 'Escala máx';
$string['maxscale_help'] = 'La máxima escala que se puede escalar hacia arriba una presentación: 1.0 = tamaño real';
$string['minscale'] = 'Escala mín';
$string['minscale_help'] = 'La máxima escala que se puede escalar hacia abajo una presentación: 0.5 = medio tamaño';
...
$string['transitionspeed_help'] = 'Velocidad de Transición';
