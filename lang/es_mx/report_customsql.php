...
<li>El token <tt>%%USERID%%</tt> en la consulta será remplazada con la ID del usuario que ve el reporte antes de que sea ejecutado el reporte.</li>
<li>Para los reportes agendados, los tokens <tt>%%STARTTIME%%</tt> y <tt>%%ENDTIME%%</tt> son remplazadas por los sellos-de-tiempo Unix (timestamp) del inicio y del final de la semana/mes reportada en la consulta antes de que ésta sea ejecutada.</li>
