...
$string['pluginname_help'] = 'En respuesta a una pregunta (que puede incluir una imagen) el alumno elige la respuesta entre varias respuestas posibles. Hay dos tipos de preguntas de opción múltiple: con una y con más de una respuesta válida.';
