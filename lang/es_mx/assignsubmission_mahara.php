...
/**
 * Strings for component 'assignsubmission_mahara', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['clicktopreview'] = 'elija para pre-visualizar en ventana emergente de tamaño completo';
$string['clicktoselect'] = 'elija para seleccionar página';
$string['default'] = 'Habilitado por defecto';
$string['default_help'] = 'Si se configura, éste método de envío será habilitado por defecto para todas las tareas nuevas.';
...
$string['err_mnetclient'] = 'Las siguientes fallas RPC: {$a}';
$string['err_save_setting'] = 'Falló al intentar guardar las configuraciones del sitio Mahara. Por favor, inténtelo de nuevo';
...
$string['noviewsfound'] = 'No se encontraron páginas coincidentes en {$a}.';
$string['pluginfile'] = 'Portafolio Mahara';
