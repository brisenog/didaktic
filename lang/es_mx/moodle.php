...
/**
 * Strings for component 'moodle', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   moodle
...
$string['coursehelpnewsitemsnumber'] = 'Número de ítems recientes del foro de avisos que aparecen  en el bloque de últimas noticias en la página del curso. Si se configura a 0 entonces el bloque de noticias no se mostrará.';
...
$string['frontpagedescriptionhelp'] = 'Este resumen puede mostrarse en la portada usando el bloque de resumen del curso/sitio o al incluir una sección de tópico en la portada.';
...
$string['missingschool'] = 'Escribir: Nombre_del_Colegio';
$string['missinglicense'] = 'Escribir: La Licencia';
...
$string['newpicture_help'] = 'Para añadir una imagen nueva, navegue y seleccione una imagen (en formato JPG o PNG) y después haga click en "Actualizar perfil". La imagen será recortada a un cuadrado y escalada a 100 * 100 pixeles.';
...
$string['notifyloginfailuresmessageend'] = 'Puede ver estas bitácoras en {$a}/course/log.php?id=1&chooselog=1&amp;modid=site_errors.';
...
$string['rsserrorauth'] = 'Su enlace RSS no contiene un token de autenticación válida.';
