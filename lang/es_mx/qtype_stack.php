...
$string['allowwords_help'] = 'Por defecto. funciones arbitrarias o nombres de variables de más de dos caracteres de longitud no están permitidas. Esta es una lista separada por comas de funciones o nombres de variables que están permitidos en una respuesta del estudiante.';
...
$string['answernote_help'] = 'Esta es una marcaque es clave para propósitos de reporte. Está designada para grabar la ruta única a través del árbol, y la resultante de cada prueba de respuesta. Esta es generada automáticamente, pero puede cambiarse por algo más significativo.';
...
$string['ATAlgEquiv_SA_not_list'] = 'Su respuesta debería ser una lista, pero no la es. Tenga en cuenta que la sintaxis para escribir una lista es incluir los valores separados por coma dentro de corchetes (paréntesis cuadrados).';
$string['ATAlgEquiv_SA_not_matrix'] = 'Su respuesta debería ser una matriz, pero no lo es.';
$string['ATAlgEquiv_SA_not_set'] = 'Su respuesta debería ser un conjunto, pero no lo es. Tenga en cuenta que la sintaxis para escribir un conjunto es incluir los valores separados por coma dentro de corchetes {}.';
...
$string['ATDiff_error_list'] = 'La prueba de respuesta falló. Por favor contacte con su administrador de sistemas';
$string['ATDiff_int'] = '¡Parece que Usted ha integrado en lugar de hacer lo que se le pidió!';
$string['AT_EmptySA'] = 'Se intentó ejecutar una prueba de respuesta con una respuesta del estudiante vacía, probablemente sea un problema de validación CAS al fabricar la pregunta.';
...
$string['ATFacForm_error_list'] = 'La prueba de respuesta falló. Por favor contacte con su administrador de sistemas';
$string['ATFacForm_isfactored'] = 'Su respuesta está factorizada, bien hecho.';
$string['ATFacForm_notalgequiv'] = 'Tenga en cuenta que su respuesta no es algebraicamente equivalente a la respuesta correcta. Usted debe de haber hecho algo mal.';
...
$string['ATInt_error_list'] = 'La prueba de respuesta falló. Por favor contacte con su administrador de sistemas';
...
$string['ATInt_logabs'] = 'La derivada formal de su respuesta no equivale a la expresión que se le pidió que integrara. Sin embargo, su respuesta difiere de la respuesta correcta de una manera significativa, lo que significa que no solamente es (por ejemplo) una constante de integración.
...
$string['ATNumSigFigs_error_list'] = 'La prueba de respuesta falló. Por favor contacte con su administrador de sistemas';
...
$string['ATPartFrac_error_list'] = 'La prueba de respuesta falló. Por favor contacte con su administrador de sistemas';
...
$string['ATSingleFrac_error_list'] = 'La prueba de respuesta falló. Por favor contacte con su administrador de sistemas';
...
$string['ATSysEquiv_SB_not_list'] = 'La respuesta del maestro no es una lista, Por favor contacte con su profesor.';
$string['ATSysEquiv_SB_not_poly_eq_list'] = 'La respuesta del maestro debería ser una lista de ecuaciones polinomiales, pero no lo es. Por favor contacte con su maestro.';
...
$string['bulktestindexintro_desc'] = 'El <a href="{$a->link}"> correr las pruebas de pregunta en un \'\'script\'\' masivamente</a> le permite correr facilmente todas las preguntas STACK en un contexto dado. No solamente prueba las preguntas, también es una fuena forma para re-poblar la caché CAS después de que ha sido limpiada.';
...
$string['defaultmarkzeroifnoprts'] = 'La calificación por defecto debe ser de 0 si esta pregunta no tiene PRTs (Potencial Response Tree = Árbol de Respuesta Potencial) .';
...
$string['deploymanynotes'] = 'Tenga en cuenta que STACK se dará por vencido si hubiera 3 intentos fallidos para generar una nueva nota de pregunta, o cuando falle una prueba de pregunta.';
...
Esta es una marca que es una clave para propósitos de reporte. Está diseñada para  grabar la ruta única a traves del árbol, y el resultante de cada prueba de respuesta. Esto es generado automáticamente, pero puede cambiarse a algo significativo.';
...
$string['sansinvalid'] = 'SAns (Respuesta del Estudiante) es iinválida: {$a}';
