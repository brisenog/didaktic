...
$string['confirmcheckforeignkeys'] = 'Esta funcionalidad buscará posibles violaciones de las claves externas  defindas en install.xml. (Moodle no genera actualmente restricciones de clave externa en la base de datos, por lo que datos no válidos pueden estar presentes.)

Es muy recomendable que se ejecuta la última (+ versión) disponible en su versión de Moodle antes de ejecutar la búsqueda de índices perdidos.
