...
$string['configcustommenuitems'] = 'Puede diseñar aquí un menú personalizado que los temas pueden mostrar. Cada línea consta de un texto del menú, un enlace URL (opcional), una herramienta (opcional) y un código de idioma o lista separada por comas de códigos de idiomas (opcional, para mostrar la línea solamente a usuarios del idioma seleccionado), separados por el caracter de línea vertical | (AltGr + 1). Puede especificar una estructura de submenús haciendo uso de guiones.
...
$string['debugstringids_desc'] = 'Esta opción está diseñada para ayudar a los traductores. Cuando esta opción está activada, si se agrega el parámetro strings=1 para una petición de URL, se mostrará el archivo de idioma y el identificador de cadena al lado de cada cadena que se emite. A veces se requiere usar el parámetro &strings=1.';
