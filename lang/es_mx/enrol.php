...
$string['extremovedaction_help'] = 'Seleccione una acción para llevar a cabo cuando la inscripción de los usuarios desaparece de la fuente de inscripción externa. Por favor tenga en cuenta que algunos datos y ajustes de los usuarios son purgados del curso durante la des-inscripción del curso.';
