...
$string['nosessiontoken'] = 'No existe un token de sesión, lo que impide exportar a Google.';
$string['oauth2upgrade_message_content'] = 'Como parte de la actualización a Moodle 2.3, el plugin del portafolios de Google Drive ha sido deshabilitado debido a cambios en los API de Google. Para re-habilitar su plugin, su sitio Moodle debe ser registrado con Google, tal como se describe en la documentación {$a->docsurl}, para obtener una ID de cliente y un secreto. La ID de client y el secreto podrán entonces usarse para configurar todos los plugins de Google Drive y Picasa.';
...
$string['oauth2upgrade_message_subject'] = 'Información importante respecto al plugin del portafolio de Google Drive';
