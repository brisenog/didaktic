...
/**
 * Strings for component 'theme_aardvark', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
...
$string['colourheadingdesc'] = 'Personalizar los colores del sitio y la imagen del fondo.';
...
$string['disclaimerdesc'] = 'El contenido de esta área-de-texto será mostrado en el pie de página de cada página.';
$string['email'] = 'Email';
...
$string['snowalert'] = 'Alerta del clima';
$string['snowalertdesc'] = 'Esto mostrará una alerta en su portada, para advertirles a ssus usuarios de cierres o información respecto a inclemencias meteorológicas.';
