...
/**
 * Strings for component 'reader', language 'es_mx', branch 'MOODLE_25_STABLE'
 *
 * @package   reader
...
$string['chooseaction'] = 'Elegir una acción y hacer click en "Ir"';
...
$string['deleterates_help'] = 'Las tasas entre exámenes de Lectura para grupos particulares o niveles de lectura serán eliminados.';
...
**Reparar**
: En el modo de reparar, todos los libros están disponibles para descargarse. Si se hubieran descargado datos previamente, serán sobre-escritos por los nuevos datos descargados. Use este modo si Usted quiere reparar exámenes defectuosos o datos incorrectos. Tenga en cuenta que aun y cuando se sobre-escriban los exámenes, los datos acerca de los intentos de los estudiantes para contestar estos exámenes serán conservados.';
...
* Su total de lectura es el número total de palabras en todos los libros que Usted ha leido.
...
* Después de que haya leido un libro, tome un examen en-línea.
* Use las cajas para búsqueda en esta página para encontrar el examen que quiere. Cuando Usted haya encontrado su examen, haga click en el botón para comenzar el examen.
* Cada examen tiene difereentes preguntas acerca del libro. Las preguntas son diferentes para cada estudiante.
...
Cualquier intento de hacer exámenes Reader antes de esta fecha no será incluido en los totales del reporte para ésto en el período actual.

Sin embargo, los intentos en períodos anteriores no son ignorados completamente. Serán incluídos en los totales del reporte para "Todos los períodos".
...
$string['quizzesmustbeinstalled'] = 'Los exámenes deben de ser instalados en un curso que está separado del curso en el cual los estudiantes ingresarán cuando tomen exámenes. El curso está oculto de los estudiantes y solamente es usado como área de almaceenaje para los exámenes; y normalmente es llamado "All Quizzes"" (Todos Exámenes). El curso que Usted ha establecido para este propósito debería de estar mostrado debajo. Si Usted aun no ha establecido un curso, por favor haga click en "Crear nuevo curso".';
...
Haga click en el botón inferior para continuar con el proceso de actualización de Moodle.';
