...
$string['propagate_help'] = 'Las traducciones preparadas se pueden propagar a ramas seleccionadas. AMOS iteractua sobre la lista de traducciones preparadas y trata de aplicarlas a cada rama seleccionada.
...
$string['stashtitledefault'] = 'T.enP. - {$a->time}';
