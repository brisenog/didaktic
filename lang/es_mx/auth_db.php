...
$string['auth_dbhost'] = 'La computadora que hospeda el servidor de la base de datos. Use una entrada de sistema DSN si usa ODBC.';
...
$string['auth_dbname'] = 'Nombre de la base de datos por sí misma. Déjelo vacío si usa una ODBC DSN';
